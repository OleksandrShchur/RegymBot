...
namespace RegymBot.Migrations
{
    ...
    [Migration("20220920185131_Clubs")]
    partial class Clubs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RegymBot.Data.Entities.ClubEntity", b =>
                {
            ...
            modelBuilder.Entity("RegymBot.Data.Entities.TGUserEntity", b =>
                {
                    b.Property<Guid>("TGUserEntityGuid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("TGUserEntityGuid");

                    b.ToTable("TGUsers");
                });

            modelBuilder.Entity("RegymBot.Data.Entities.UserClubEntity", b =>
                {
                    b.Property<Guid>("UserRef")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("ClubRef")
                        .HasColumnType("int");

                    b.HasKey("UserRef", "ClubRef");
            ...
            modelBuilder.Entity("RegymBot.Data.Entities.UserClubEntity", b =>
                {
                    b.HasOne("RegymBot.Data.Entities.ClubEntity", "Club")
                        .WithMany("UserClubs")
                        .HasForeignKey("ClubRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
